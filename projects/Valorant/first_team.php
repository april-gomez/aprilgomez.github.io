...
if(isset($_POST['submit'])) {
    ...
    if(mysqli_num_rows($check_username) == 0) {
        ...
        $insert = mysqli_query($conn, "INSERT INTO first_team (username, first_name, last_name, ign_valo, number, email, appointment_date) VALUES('$username', '$first_name', '$last_name', '$ign_valo', '$number', '$email', '$appointment_date')") or die ('Query Failed.');
